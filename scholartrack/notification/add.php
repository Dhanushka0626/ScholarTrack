...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO notification (NotificationID, Message, DateSent) VALUES ('$id', '$msg', '$date')";
...
<head>
  <meta charset="UTF-8">
  <title>Add Notification | ScholarTrack</title>
  <style>
    body {
...
<body>
  <div class="form-container">
    ...
    <form method="POST">
      ...
      <input type="text" name="NotificationID" required>
